...
import { HERO_WORDS, TESTIMONIALS, PHONE_NUMBER, WA_LINK } from "../../constants/data";
import Stars from "../common/Stars";
import Typewriter from "../common/Typewriter";
import WhatsAppIcon from "../common/WhatsAppIcon";
import GoldBtn from "../ui/GoldBtn";

export default function Hero({ go, storyIdx, heroY, heroOp, SH, SUB }) {
  return (
        ...
        <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", alignItems: "center", gap: 80 }}>
          ...
          <div className="hero-copy" style={{ maxWidth: 650 }}>
            ...
            <motion.h1 className="hero-h" initial={{ opacity: 0, y: 48 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1, ease: [0.22, 1, 0.36, 1] }}
              style={{ ...SH, fontSize: 70, fontWeight: 900, lineHeight: 1.02, color: C.white, marginBottom: 22, textShadow: "0 18px 55px rgba(0,0,0,.35)" }}>
              Your Gateway to<br />
