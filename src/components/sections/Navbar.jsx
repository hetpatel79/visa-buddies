...
import { NAV, NAV_TARGET } from "@/constants";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        <div className="hide-mob" style={{ display: "flex", gap: 14, alignItems: "center", overflowX: "auto", scrollbarWidth: "none", maxWidth: "56vw" }}>
          {NAV.map((l) => (
            <span key={l} className="nav-a" onClick={() => go(NAV_TARGET[l] || l.toLowerCase().replace(/ /g, "-"))}>{l}</span>
          ))}
        </div>
        <div className="hide-mob" style={{ flexShrink: 0 }}>
